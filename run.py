...
def main():
    ...
    while True:
        ...
        if short_code == "cc":
            ...
            while True:
                print(
                    " TP - Type your own pasword if you already have an account:\n GP - Generate a random Password")
            ...
            print('\n')
            print(
                f"Account Credential for:Account {account} :Username: {username} - Password:{password} created succesfully")
            print('\n')
        elif short_code == "fc":
